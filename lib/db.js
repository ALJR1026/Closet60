...
// admin panel.
const DEFAULT_BANNER_SLIDE = { enabled: false, image: '', title: '', subtitle: '', linkUrl: '#shop' };
...
module.exports = { load, save, ensureDB, getSecret, CATEGORY_LABELS, DATA_DIR, DEFAULT_SITE_CONTENT, withSiteContentDefaults, THEMES, USE_REDIS };
